    ...
    return (
      <>
        <img
          ...
          alt="account"
        />
        <p className="Sidebar__account-name item--text">Андрей Андриянов</p>
      </>
    );
  }, []);
          ...
          {localStorage.token && (
            <div className="nav-link-reset">
              <li className="Sidebar__navigation-item item--wrapper item--premium">
                {/*<img className="Sidebar__icon margin--no" src={require("../AppHeader/assets/premium.svg").default} alt="premium"/>*/}
